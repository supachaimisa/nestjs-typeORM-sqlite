...
import { addResolveFunctionsToSchema, addErrorLoggingToSchema, SchemaDirectiveVisitor } from '@kamilkisiela/graphql-tools';
...
function mergeSchemas({ schemas, typeDefs, resolvers, resolversComposition, schemaDirectives, resolverValidationOptions, logger, ...config }) {
    ...
    let schema = typeof typeDefsOutput === 'string'
